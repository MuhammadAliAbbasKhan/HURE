...
import mockJobs from '../../utils/Website/mockJobs.js';
...
const HUREHire = () => {
  ...
  // Get website data
  const website = websites[0]; // Assuming there's only one website in the array

  // Mock data fetch
  useEffect(() => {
  setTimeout(() => {
    const fetchedJobs = mockJobs ?? []; // fallback to empty array if undefined/null
  ...
  const handleApply = (e) => {
    e.preventDefault();
    // In a real app, you would upload the CV and send the application
    alert(`Application submitted for ${selectedJob.title} at ${selectedJob.facility}`);
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  <p className="mb-2" style={{ color: styles.primaryColor5 }}>
                    <span className="font-medium">Facility:</span> {selectedJob.facility}
                  </p>
                  <p className="mb-2" style={{ color: styles.primaryColor5 }}>
