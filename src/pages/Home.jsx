...
const HeroSection = ({ website, gradientBackground, setIsDemoModalOpen }) => {
...
// ======================
const WebsiteInfoSection = ({ website, colors }) => {
  const [ref, inView] = useInView({ triggerOnce: true, threshold: 0.2 });
  const controls = useAnimation();
...
//       <HeroSection website={website} colors={colors} gradientBackground={gradientBackground} />
//       <WebsiteInfoSection website={website} colors={colors} />
//       {/* <SliderSection colors={colors} /> */}
