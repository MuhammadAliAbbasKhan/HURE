...
const SignUp = () => {
  ...
  return (
    <motion.div 
      ...
      className="min-h-screen w-full mt-24 flex flex-col justify-center items-center px-8 sm:px-20 py-12"
    ...
    >
      ...
      >
        {/* Input Fields */}
        {[
          { label: t("username"), value: username, setter: setUsername, type: "text" },
          ...
          { label: t("confirmPassword"), value: confirmPassword, setter: setConfirmPassword, type: "password" },
